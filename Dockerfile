...
RUN wget https://github.com/lonelycode/tyk/releases/download/v1.8/tyk-dashboard-amd64-v0.9.6.tar.gz
RUN tar -xvzf tyk-dashboard-amd64-v0.9.6.tar.gz -C /opt
RUN mv /opt/tyk-analytics-v0.9.6 /opt/tyk-dashboard
