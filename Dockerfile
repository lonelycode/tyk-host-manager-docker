...
RUN wget https://github.com/lonelycode/tyk/releases/download/1.6/tyk-dashboard-amd64-v0.9.4.3.tar.gz
RUN tar -xvzf tyk-dashboard-amd64-v0.9.4.3.tar.gz -C /opt
RUN mv /opt/tyk-analytics-v0.9.4.3 /opt/tyk-dashboard
